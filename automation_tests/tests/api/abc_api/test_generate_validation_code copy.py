...
from constants.api.abc_api import INVALID_customer_id
...
class TestGenerateValidationCode:
    ...
    def test_generate_validation_code_with_invalid_customer_id(self, customer):
        assert_error_message(customer, AbcFactory(customer).payload_code_generate(INVALID_customer_id).generate_code(
